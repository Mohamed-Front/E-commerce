...
export default {
  ...
  "shippingSetting": {
    "managementTitle": "إدارة إعدادات التوصيل",
    "search": "البحث في إعدادات التوصيل",
    "export": "تصدير إعدادات التوصيل",
    "exportSuccess": "تم تصدير إعدادات التوصيل بنجاح",
    "exportError": "فشل في تصدير إعدادات التوصيل",
    "new": "إعداد توصيل جديد",
    "storeNameEn": "اسم المتجر (بالإنجليزية)",
    "storeNameAr": "اسم المتجر (بالعربية)",
    "isEnabled": "مفعل",
    "minAmount": "الحد الأدنى للطلب",
    "freeAmount": "مبلغ التوصيل المجاني",
    "expressEnabled": "التوصيل السريع مفعل",
    "days": "أيام التوصيل",
    "fromTime": "من الساعة",
    "toTime": "إلى الساعة",
    "yes": "نعم",
    "no": "لا",
    "noData": "لم يتم العثور على إعدادات توصيل",
    "loadError": "فشل في تحميل إعدادات التوصيل",
    "deleteConfirmTitle": "تأكيد الحذف",
    "deleteConfirmMessage": "هل أنت متأكد من رغبتك في حذف إعداد التوصيل هذا؟",
    "deletedSuccess": "تم حذف إعداد التوصيل بنجاح",
    "deleteError": "فشل في حذف إعداد التوصيل",
    "createTitle": "إنشاء إعداد توصيل",
    "editTitle": "تعديل إعداد التوصيل",
    "createShipping": "إنشاء إعداد توصيل",
    "updateShipping": "تحديث إعداد التوصيل",
    "store": "المتجر",
    "selectStore": "اختر متجرًا",
    "loadStoresError": "فشل في تحميل المتاجر",
    "enterMinAmount": "أدخل الحد الأدنى للطلب",
    "enterFreeAmount": "أدخل مبلغ التوصيل المجاني",
    "selectDays": "اختر أيام التوصيل",
    "enterFromTime": "أدخل وقت البدء",
    "enterToTime": "أدخل وقت الانتهاء",
    "latitude": "خط العرض",
    "enterLatitude": "أدخل خط العرض",
    "longitude": "خط الطول",
    "enterLongitude": "أدخل خط الطول",
    "zones": "مناطق التوصيل",
    "zoneFrom": "المنطقة من (كم)",
    "enterZoneFrom": "أدخل مسافة البدء للمنطقة",
    "zoneTo": "المنطقة إلى (كم)",
    "enterZoneTo": "أدخل مسافة الانتهاء للمنطقة",
    "fee": "رسوم التوصيل",
    "enterFee": "أدخل رسوم التوصيل",
    "expressTime": "وقت التوصيل السريع (الساعات)",
    "enterExpressTime": "أدخل وقت التوصيل السريع",
    "expressFee": "رسوم التوصيل السريع",
    "enterExpressFee": "أدخل رسوم التوصيل السريع",
    "addZone": "إضافة منطقة",
    "atLeastOneZone": "مطلوب منطقة واحدة على الأقل",
    "createdSuccess": "تم إنشاء إعداد التوصيل بنجاح",
    "createError": "فشل في إنشاء إعداد التوصيل",
    "updatedSuccess": "تم تحديث إعداد التوصيل بنجاح",
    "updateError": "فشل في تحديث إعداد التوصيل"
  },
  user: {
...
"error": "خطأ",
  ...
  orders: {
    ...
    statusPending: 'تم الطلب يوم  وجاري التوصيل',
    statusDelivered: 'تم توصيل الطلب بنجاح',
    statusCancelled: 'تم إلغاء الطلب يوم ',
    statusUnknown: 'حالة الطلب غير معروفة',
    previous: 'السابق',
    next: 'التالي',
    page: 'الصفحة ',
    notAvailable: 'غير متوفر',
