...
const fetchShippingSetting = async () => {
  ...
  try {
    ...
    const data = response.data.data.store_shipping_setting;
      shippingData.value.store_id=route.params.id
    if(response.data.data.store_shipping_setting)
    shippingData.value = {
...
const submitForm = async () => {
  ...
  try {
    ...
    await axios.post(`/api/store/shipping/setting/update`, shippingData.value, {
