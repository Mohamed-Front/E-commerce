    ...
    <nav class="h-[56px] bg-[#fff] flex py-2 px-4 md:hidden relative shadow-sm">
      <div class="w-full flex justify-between items-center">
          ...
          <transition name="dropdown">
            <div v-if="isDropdownOpen" class="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-xl z-50 overflow-hidden">
              <div
                ...
                :class="{ 'bg-yellow-50': store.id === defaultStoreId }"
              >
                <img v-if="getStoreImage(store)" :src="getStoreImage(store)" alt="Store Logo" class="h-6 w-10 object-contain mr-2" />
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="relative">
            <span class="icon-container bg-[#F2EDDE] cursor-pointer hover:bg-gray-200 transition-colors" @click="toggleUserDropdown">
              <i class="fa-solid fa-user text-black"></i>
            </span>
            <transition name="dropdown">
              <div v-if="isUserDropdownOpen && isAuthenticated" class="absolute top-full right-0 mt-2 w-48 bg-white rounded-lg shadow-xl z-50 overflow-hidden">
                ...
                <div
                  ...
                  class="flex items-center px-4 py-3 hover:bg-gray-100 transition-all duration-200 cursor-pointer"
                >
                  <i class="fa-solid fa-sign-out-alt mx-2"></i>
      ...
      <div class="w-full flex items-center justify-between">
        ...
        <div class="flex items-center justify-end ml-5 gap-3">
          ...
          <div class="relative" v-if="isAuthenticated">
            <span class="icon-container bg-[var(--main-text-color)] cursor-pointer hover:bg-gray-700 transition-colors" @click="toggleUserDropdown">
            ...
            <transition name="dropdown">
              <div v-if="isUserDropdownOpen" class="absolute top-full right-0 mt-2 w-48 bg-white rounded-lg shadow-xl z-50 overflow-hidden">
                <div class="px-4 py-3 border-b border-gray-200">
                  <p class="text-sm font-semibold text-gray-700">{{ webUser.name }}</p>
                  <p class="text-xs text-gray-500">{{ webUser.phone }}</p>
                </div>
