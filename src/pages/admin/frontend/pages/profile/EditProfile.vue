...
<template>
  ...
  <div class="min-h-screen p-8 font-inter">
    ...
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row gap-6">
      ...
      <!-- Main content section with user information and form -->
        ...
        <form v-if="!loading" @submit.prevent="saveChanges" class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div class="relative rounded-md shadow-sm">
              ...
              <input type="text" id="username" v-model="username" class="w-full px-4 py-3 pl-10 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200" :class="{ 'border-red-500': errors.username }" />
          ...
          <div class="md:col-span-2">
            ...
            <div class="flex items-center rounded-md shadow-sm border border-gray-300 rounded-xl focus-within:ring-blue-500 focus-within:border-blue-500 transition-colors duration-200" :class="{ 'border-red-500': errors.phoneNumber }">
              <input type="tel" id="phone" v-model="phoneNumber" class="flex-1 block w-full px-4 py-3 bg-white rounded-r-xl focus:outline-none" />
            </div>
          ...
          <div class="md:col-span-2 flex justify-end gap-4 mt-8">
            <button type="button" @click="cancel" class="px-6 py-3 border border-blue-500 text-blue-500 font-medium rounded-xl hover:bg-blue-50 transition-colors duration-200" :disabled="loading">إلغاء</button>
            <button type="submit" class="px-6 py-3 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 transition-colors duration-200" :disabled="loading">حفظ التغييرات</button>
          </div>
        </form>
...
<style scoped>
/*
 * Custom styles are not necessary here, as all styling is handled by
 * Tailwind CSS utility classes. The 'scoped' attribute ensures
