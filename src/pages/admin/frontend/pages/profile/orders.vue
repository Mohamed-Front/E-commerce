  ...
  <div class="min-h-screen p-8 bg-gray-100 font-inter" dir="rtl">
    ...
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row gap-6">
      ...
      <aside class="w-full md:w-64 bg-white rounded-xl shadow-md p-6 h-fit">
        <ul class="space-y-2">
          <li @click="" class="p-3 rounded-lg flex items-center gap-4 text-gray-500 hover:bg-gray-50 cursor-pointer">
          ...
          <li class="p-3 rounded-lg flex items-center gap-4 text-red-500 hover:bg-gray-50 cursor-pointer">
            <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <main class="flex-1">
        ...
        <div class="space-y-6">
          <div class="bg-white rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center gap-4">
            <div class="flex-shrink-0 flex items-center gap-2">
              <div class="bg-gray-100 rounded-lg p-2 w-16 h-16 flex items-center justify-center">
                <img src="https://placehold.co/40x40/f1f1e7/585858?text=🍲" alt="Product Image" class="w-full h-full object-contain">
              </div>
              <div class="bg-gray-100 rounded-lg p-2 w-16 h-16 flex items-center justify-center">
                <img src="https://placehold.co/40x40/f1f1e7/585858?text=🍲" alt="Product Image" class="w-full h-full object-contain">
              </div>
            ...
            <div class="flex-1 text-center md:text-right">
              <p class="text-yellow-600 font-medium mb-1">تم الطلب يوم 20 يناير 2024 وجاري التوصيل</p>
              <p class="text-gray-500 text-sm">رقم الطلب 546544465</p>
            </div>
            <div class="text-center md:text-left mt-4 md:mt-0">
              <a href="#" class="text-blue-500 font-medium hover:underline">تصفح الطلب</a>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center gap-4">
            ...
            <div class="flex-1 text-center md:text-right">
              <p class="text-green-600 font-medium mb-1">تم توصيل الطلب بنجاح</p>
              <p class="text-gray-500 text-sm">رقم الطلب 546544465</p>
            </div>
            <div class="text-center md:text-left mt-4 md:mt-0">
              <a href="#" class="text-blue-500 font-medium hover:underline">تصفح الطلب</a>
          ...
          <div class="bg-white rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center gap-4">
            ...
            <div class="flex-1 text-center md:text-right">
              <p class="text-red-600 font-medium mb-1">تم الغاء الطلب يوم 24 يناير 2024</p>
              <p class="text-gray-500 text-sm">رقم الطلب 546544465</p>
            </div>
            <div class="text-center md:text-left mt-4 md:mt-0">
              <a href="#" class="text-blue-500 font-medium hover:underline">تصفح الطلب</a>
